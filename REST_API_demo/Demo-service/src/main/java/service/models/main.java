    ...
    public static void main(String[] args) {
        ...
        try {
           ...
           /* String[] getOperations = {BASE_URI.toURL() + "students/hello",
            ...
            String[] getCountryOperations = {BASE_Country_URI.toURL() + "/hello",
                    BASE_Country_URI.toURL() + "/2"};

            for (String getOperation : getOperations) {
                System.out.println(getOperation);
            }

            for (String getCountryOperation : getCountryOperations) {
                System.out.println(getCountryOperation);
            }*/
