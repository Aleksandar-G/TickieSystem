...
export default function AddUser() {
  ...
  const apicall = (hash) => {
    instance
      .post("http://localhost:8080/db/user/add", {
        name: name,
        level: level,
        password: hash,
      })
      ...
      <Container component="main" maxWidth="xs">
        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate>
            ...
            {error && (
              <div className="alert alert-warning">Fill all the fields</div>
            )}
            {passwordLengthError && (
              <div className="alert alert-warning">Password is too short</div>
            )}
            <TextField
              variant="outlined"
              margin="normal"
